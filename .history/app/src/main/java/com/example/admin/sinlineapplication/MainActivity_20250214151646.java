...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                if (!frequency.getText().toString().trim().equals("")
                    ...
                    if (sw.getVisibility() == View.VISIBLE) {
                        ...
                        editor.putFloat("extremum", Float.parseFloat(extremum.getText().toString()));
                        editor.putFloat("amplifier_u", Float.parseFloat(amplifier_u.getText().toString()));
                        editor.putFloat("amplifier_v", Float.parseFloat(amplifier_v.getText().toString()));
                        editor.putFloat("amplifier_w", Float.parseFloat(amplifier_w.getText().toString()));
                        editor.putFloat("frequency", Float.parseFloat(frequency.getText().toString()));
                        editor.putFloat("speed", Float.parseFloat(speed.getText().toString()));
                        editor.commit();
                    }
                    ...
                    if (bw.getVisibility() == View.VISIBLE) {
                        ...
                        SharedPreferences.Editor editor = userSettings.edit();
                        editor.putFloat("extremumA", Float.parseFloat(extremum.getText().toString()));
                        editor.putFloat("max_u", Float.parseFloat(amplifier_u.getText().toString()));
                        editor.putFloat("max_v", Float.parseFloat(amplifier_v.getText().toString()));
                        editor.putFloat("max_w", Float.parseFloat(amplifier_w.getText().toString()));
                        // editor.putFloat("frequency",
                        // Float.parseFloat(frequency.getText().toString()));
                        editor.putFloat("speedA", Float.parseFloat(speed.getText().toString()));
                        editor.commit();
                    }
        ...
        modbusDataManager.setOnDataUpdateListener(new ModbusDataManager.OnDataUpdateListener() {
            @Override
            public void onDataUpdate(float[] data) {
                // 更新UI显示
